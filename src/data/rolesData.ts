...
export const mockRoles: SystemRole[] = [
  ...
  { id: 'ROLE-002', name: 'Faculty', description: 'Access to student, credential, and attendance operations assigned to faculty.', status: 'Active', isSystem: true, permissions: viewPermissions(['Dashboard', 'Student Management', 'QR Code Management', 'RFID Management', 'Attendance Monitoring', 'Attendance Records', 'Analytics', 'Notifications']) },
