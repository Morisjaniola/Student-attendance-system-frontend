...
/** Dashboard data refreshes every 15 seconds so module changes appear quickly. */
const DASHBOARD_STALE_TIME = 15_000

export function DashboardPage() {
  const navigate = useNavigate()
  const { data, isPending, isError } = useQuery({ queryKey: ['dashboard'], queryFn: getDashboardData, staleTime: DASHBOARD_STALE_TIME, refetchInterval: DASHBOARD_STALE_TIME })
