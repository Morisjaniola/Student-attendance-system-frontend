    ...
    <>
      ...
      >
        ...
        <nav
          className={`${
            compact ? 'mt-9' : ''
          } min-h-0 flex-1 space-y-1 overflow-x-hidden overflow-y-auto pr-1 [scrollbar-width:thin]`}
        ...
        <div className="mt-4 shrink-0 space-y-1 border-t border-slate-100 pt-4 dark:border-slate-800">
          {canViewSettings && (
            <NavLink
              to="/settings"
              onClick={onClose}
              title={compact ? 'System Settings' : undefined}
              className={({ isActive }) =>
          ...
          <button
            ...
            className={`flex h-11 w-full items-center rounded-xl px-3 text-sm font-medium text-rose-600 transition hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-500/10 ${
              compact ? 'lg:justify-center lg:px-0' : ''
            }`}
          >
          ...
          <button
            ...
            className="hidden h-10 w-full items-center rounded-xl px-3 text-sm font-medium text-slate-400 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-900 dark:hover:text-white lg:flex"
          >
            <ChevronLeft
              size={18}
